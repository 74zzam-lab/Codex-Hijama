...
(() => {
  ...
  check(step === 'path_decision' || step === 'organization' || step === 'branch', 'restart after discovery resumes post-discovery step');
})();
...
(() => {
  ...
  check(w.wizardFlowVersion === 8 || w.wizardFlowVersion === 7, 'legacy wizard migrated to flow v8+');
