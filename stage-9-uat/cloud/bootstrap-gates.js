...
(function (global) {
  ...
  function getStepInventory() {
    return [
      ...
      { stepId: 'branch', displayName: 'إنشاء أول فرع', path: 'NEW', currentPositionNew: 7, uiRenderer: 'renderStepUI:branch', entry: 'createFirstBranchFromForm / bindExistingBranch', completionChecker: 'hasBranch()&&hasDeviceBranch()', sourceOfTruth: 'license.branches+DeviceConfig', writes: ['device config', 'device registry', 'license branches', 'RESTART_REQUIRED'], cloudEffect: false, sqliteEffect: true, canRetry: true, canResume: true, canSkip: false, dependsOn: ['owner'], produces: ['branch', 'device registration'] },
