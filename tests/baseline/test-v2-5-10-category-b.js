...
check(/showSection/.test(hub) && /dailyKpis/.test(hub) && /advancedSupport/.test(hub)
  && /data-oh-panel="overview"/.test(hub) && /data-oh-panel="advanced"/.test(hub),
  'Owner Hub overview vs advanced sections');
