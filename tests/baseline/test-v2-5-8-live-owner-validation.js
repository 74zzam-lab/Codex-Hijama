...
const sandbox = {
  ...
  DB: {
    ...
    set(k, v) { this._d[k] = v; return { ok: true, key: k }; }
  },
  ...
  hashPW: async (_pw, username) => 'pbkdf2:' + (username || 'owner') + ':' + 'a'.repeat(64)
};
...
(async () => {
  ...
  sandbox.users = [{
    id: 'o1', username: 'o1', role: 'owner', active: true,
    password: 'pbkdf2:o1:' + 'b'.repeat(64)
  }];
  ...
  await OM.deleteOwner(sandbox.users.find(u => u.username === 'secondowner').id);
