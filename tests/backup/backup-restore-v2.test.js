...
function seedUserData(userDataDir, clientId, centerId = 'CTR-A', branchId = 'BR-1') {
  ...
  db.prepare(
    ...
    clientId, 'Client ' + clientId, '0500000000', centerId, branchId,
    JSON.stringify({ id: clientId, centerId, branchId, name: 'Client ' + clientId }),
...
async function main() {
  ...
  seedUserData(otherDir, 'c-other', 'CTR-B', 'BR-9');
