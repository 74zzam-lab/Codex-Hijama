...
(function (global) {
  ...
  function actionMoreToggle(menuId) {
    return `<button type="button" class="btn btn-ghost btn-sm btn-action btn-action-more" data-tdw-event="click" data-tdw-handler="action-more" data-menu-id="${esc(menuId)}" title="المزيد" aria-haspopup="true" aria-expanded="false"><span class="btn-ico">⋮</span><span class="btn-lbl">مزيد</span></button>`;
  }
