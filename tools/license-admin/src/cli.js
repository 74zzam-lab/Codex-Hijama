...
function cmdIssue(args) {
  ...
  const signed = issueLicense({
    ...
    deviceBinding: args.bind
      ...
      : { mode: 'any' },
    seq: args.seq,
    keyId: args.keyId || process.env.TADAWI_LICENSE_KEY_ID || 'prod-ed25519-2026-a7f929f51598',
    centerId: args.centerId,
    centerName: args.centerName || args.name,
    branches: args.centerId ? [{
      id: args.branchId || 'BR-MAIN',
      name: args.branchName || args.centerName || args.name || 'Main Branch',
      code: args.branchCode || 'MAIN',
      active: true,
    }] : undefined,
  }, priv);
