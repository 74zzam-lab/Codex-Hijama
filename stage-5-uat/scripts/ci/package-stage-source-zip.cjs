...
const EXCLUDE_DIRS = new Set([
  ...
  '01-ORIGINAL', '02-CURRENT', '03-REPORTS', 'stage-1-uat', 'stage-2-uat', 'stage-3-uat', 'stage-4-uat', 'stage-5-uat', 'app-source',
]);
...
const buildId = process.env.STAGE5_BUILD_ID || process.env.STAGE4_BUILD_ID || process.env.STAGE3_BUILD_ID || process.env.STAGE2_BUILD_ID || 'local';
const evidenceSubdir = stage === '5'
...
const required = ['package.json', 'cloud/ready-pure-evaluator.js', 'cloud/setup-state-service.js', 'cloud/bootstrap-gates.js', 'tests/baseline/test-stage-2-ready-pure.js', 'tests/baseline/test-stage-5-bootstrap-gate-map.js'];
