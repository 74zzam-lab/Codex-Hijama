...
const EXCLUDE_DIRS = new Set([
  ...
  '01-ORIGINAL', '02-CURRENT', '03-REPORTS', 'stage-1-uat', 'stage-2-uat', 'stage-3-uat', 'app-source',
]);
...
const buildId = process.env.STAGE3_BUILD_ID || process.env.STAGE2_BUILD_ID || 'local';
const evidenceSubdir = stage === '3' ? 'STAGE-3-NO-AUTO-BOOT' : `STAGE-${stage}-READY-PURE`;
