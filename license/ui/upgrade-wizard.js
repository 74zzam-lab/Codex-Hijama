    ...
    if (_result) {
      body.innerHTML = `
        ...
        <div class="lic-v2-actions-row">
          ...
          <button type="button" class="lic-v2-btn lic-v2-btn-secondary" id="lic-v2-upg-sheet">ðŸ“Š صف activations</button>
          <button type="button" class="lic-v2-btn lic-v2-btn-secondary" id="lic-v2-upg-bundle">ðŸ“¦ bundle للشيت</button>
        </div>`;
      ...
      el('lic-v2-upg-sheet').onclick = () => CL.drawer?.copyVaultActivationRow?.(_result);
      el('lic-v2-upg-bundle').onclick = () => CL.drawer?.copyVaultBundleRow?.(_result);
      return;
    }
    body.innerHTML = `
      <p>وضع الترقية:</p>
