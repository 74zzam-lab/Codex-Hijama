(function (global) {
  ...
  async function loadDataIndex() {
    // Customer runtime licence artifacts are authoritative only in the
    // configured per-user LicenseAdmin root (through Main IPC). Repository
    // fixture data must never be fetched from packaged application resources.
    CL.dataIndex = null;
    CL.auditFile = null;
    return { dataIndex: null, auditFile: null };
  }
