...
function readyEnv(overrides = {}) {
  ...
  const snap = {
    ...
    wizard: { path: 'new', currentStep: 0, restoreChoice: 'empty', syncDone: false, completedSteps: [], wizardFlowVersion: 6 },
...
(() => {
  const ctx = readyEnv({
    ...
    deviceConfig: { deviceUuid: '', lockedBranchId: '', deviceName: '' },
    wizard: { path: 'new', currentStep: 7, completedSteps: ['language', 'google', 'license', 'organization'], restoreChoice: 'empty', wizardFlowVersion: 6 },
  });
