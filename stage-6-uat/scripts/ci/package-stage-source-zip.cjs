...
const buildId = process.env.STAGE6_BUILD_ID || process.env.STAGE5_BUILD_ID || process.env.STAGE4_BUILD_ID || process.env.STAGE3_BUILD_ID || process.env.STAGE2_BUILD_ID || 'local';
const evidenceSubdir = stage === '6'
...
const required = ['package.json', 'cloud/boot-flow-ui.js', 'cloud/bootstrap-gates.js', 'tests/baseline/test-stage-6-activation-before-google.js'];
